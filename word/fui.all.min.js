...
!function () {
    ...
    _p[0] = {
        ...
        value: function () {
            var a = _p.r(11);
            a.___register({ALLOW_FOCUS: !0}), a.___register({
                Widget: _p.r(60),
                Icon: _p.r(42),
                Label: _p.r(48),
                Button: _p.r(37),
        ...
        value: function () {
            var a = _p.r(4), b = "__fui__marker__" + +new Date;
            return {
        ...
        value: function () {
            function a(a) {
                this.__options = b.extend({}, d, a), this.__started = !1, this.__point = {
                    x: 0,
                    y: 0
                }, this.__location = {x: 0, y: 0}, this.__range = {top: 0, left: 0, bottom: 0, right: 0}
            }

            var b = _p.r(4), c = _p.r(6), d = {handler: null, target: null, axis: "all", range: null};
            return b.extend(a.prototype, {
                bind: function (a) {
                    ...
                    b(a).on("mousedown", function (b) {
                        if (1 === b.which) {
                            ...
                            b.preventDefault(), d.__started = !0, d.__point = {
                                x: b.clientX,
                                y: b.clientY
                            }, d.__location = {x: e.left, y: e.top}, d.__range = d.__getRange()
                        }
                    ...
                    var a = this.__rangeNode, d = c.getRect(this.__target);
        ...
        value: function () {
            var a = {};
            return {
                widgets: a, __export: function () {
                    window.FUI = this
                }, ___register: function (a, b) {
                    if ("string" == typeof a)this[a] = b; else {
                        b = a;
        ...
        value: function () {
            ...
            return {
                ...
                control: {input: 1, textarea: 1, button: 1, select: 1, option: 1, object: 1, embed: 1}
            }
        }
    }, _p[13] = {
        value: function () {
            var a = _p.r(4), b = {Tpl: _p.r(7), Widget: _p.r(10), createDraggable: _p.r(8)};
        ...
        value: function () {
            var a = _p.r(4), b = _p.r(12), c = _p.r(14);
            return _p.r(13).createClass("TPicker", {
                base: _p.r(60), constructor: function (b) {
                    var c = {row: 10, col: 10};
                    ...
                    this.trigger("pickerselect", {row: a + 1, col: b + 1})
        ...
        value: function () {
            var a = _p.r(4), b = _p.r(12), c = _p.r(15), d = _p.r(48), e = _p.r(16), f = _p.r(37), g = _p.r(54), h = _p.r(49);
            return _p.r(13).createClass("TablePicker", {
                base: _p.r(60), constructor: function (b) {
                    ...
                    this.callBase(), this.__pickerWidget = new e(this.__options), this.__labelWidget = new d({text: "\u63d2\u5165\u8868\u683c"}), this.__buttonWidget = new f(this.__options.button), this.__panelWidget = new g({
                    ...
                    this.callBase(), this.__buttonWidget.on("btnclick", function () {
                        ...
                        var d = c.row + 1, e = c.col + 1;
                        a.__labelWidget.setText(d + "x" + e + " \u8868\u683c")
                    }).on("pickerselect", function (b, c) {
                        var d = c.row, e = c.col;
                        a.close(), a.trigger("pickerselect", {row: d, col: e})
                    })
                }, __createBackplane: function () {
                    for (var c = [], d = null, e = 0, f = this.__options.row; f > e; e++) {
                        d = [];
        ...
        value: function () {
            var a = _p.r(4), b = _p.r(12), c = _p.r(18), d = _p.r(37), e = _p.r(50), f = _p.r(49), g = b.layout;
            return _p.r(13).createClass("ButtonMenu", {
                base: _p.r(60), constructor: function (b) {
                    var c = {menu: null, mask: null, buttons: [], selected: -1, layout: g.RIGHT};
                    b = a.extend({}, c, b), this.callBase(b)
                }, open: function () {
                    ...
                    var c = [], e = this.__element, f = null, h = this.__options.buttons.length - 1;
                    ...
                    var b = this.__buttonWidgets[this.__buttonWidgets.length - 1], c = this;
                    this.callBase(), b.on("click", function () {
                        ...
                        c > -1 && c < this.__buttonWidgets.length - 1 && this.trigger("buttonclick", {button: this.__buttonWidgets[c]})
                    })
                }
            })
        }
        ...
        value: function () {
            var a = _p.r(4), b = _p.r(25), c = _p.r(43), d = _p.r(50), e = _p.r(49), f = _p.r(13);
            return _p.r(13).createClass("InputMenu", {
                base: _p.r(60), constructor: function (a) {
                    ...
                    var b = this.getValue(), c = b.toLowerCase(), d = this.__getItemValues(), e = null;
                    ...
                    var b = this.__getItemValues(), c = -1, d = this.getValue(), e = this.__lastSelect;
        ...
        value: function () {
            var a = _p.r(4), b = _p.r(12), c = _p.r(59);
            return _p.r(13).createClass("Buttonset", {
                base: _p.r(51), constructor: function (b) {
                    var c = {selected: -1};
                    b = a.extend({}, c, b), this.callBase(b)
                }, getButtons: function () {
                    ...
                    this.__prevIndex = this.__currentIndex, this.__currentIndex = this.indexOf(b), this.__currentIndex !== this.__prevIndex && (b && b.press(), a.each(this.__widgets, function (a, c) {
                        c !== b && c.bounce()
                    }), this.trigger("change", {currentIndex: this.__currentIndex, prevIndex: this.__prevIndex}))
                }, __valid: function (a) {
        ...
        value: function () {
            var a = _p.r(4), b = _p.r(12), c = _p.r(19), d = _p.r(42), e = _p.r(48);
            return _p.r(13).createClass("Button", {
                base: _p.r(60), constructor: function (b) {
                    var c = {label: null, text: null, icon: null, layout: "right"};
                    b = a.extend({}, c, b), this.callBase(b)
                }, getLabel: function () {
                    ...
                    this.callBase(), this.widgetName = "Button", this.__tpl = c, this.__iconWidget = null, this.__labelWidget = null, "object" != typeof this.__options.label && (this.__options.label = {text: this.__options.label}), "object" != typeof this.__options.icon && (this.__options.icon = {img: this.__options.icon})
                }, __initEvent: function () {
        ...
        value: function () {
            var a = _p.r(13), b = _p.r(12), c = _p.r(49), d = _p.r(20), e = _p.r(4);
            return a.createClass("ColorPicker", {
                base: _p.r(54), constructor: function (a) {
                    var b = {
                        clearText: "",
                        commonText: "",
        ...
        value: function () {
            var a = _p.r(13), b = _p.r(12), c = _p.r(60), d = _p.r(0), e = _p.r(4);
            return a.createClass("Container", {
                base: c, constructor: function (a) {
                    ...
                    if (this.__options.widgets) {
                        var a = d.parse(this.__options.widgets), b = this;
        ...
        value: function () {
            var a = _p.r(13), b = _p.r(12), c = _p.r(60), d = _p.r(49), e = _p.r(21), f = _p.r(37), g = b.layout, h = _p.r(4), i = {
                CANCEL: "cancel",
                OK: "ok"
            };
            return a.createClass("Dialog", {
                base: _p.r(54), constructor: function (a) {
                    var c = {
                        ...
                        draggable: !0,
                        closeButton: !0,
                        mask: {color: "#000", opacity: .2},
                        prompt: !1,
                        buttons: [{
                            className: b.classPrefix + "xdialog-ok-btn",
                            action: "ok",
                            label: "\u786e\u5b9a"
                        }, {className: b.classPrefix + "xdialog-cancel-btn", action: "cancel", label: "\u53d6\u6d88"}]
                    };
                    ...
                    var a = this, b = null, c = this.__footElement;
                    ...
                    a.createDraggable({handler: this.__headElement, target: this.__element}).bind()
                    ...
                    if (!this.__hinting) {
                        this.__hinting = !0;
                        var a = h(this.__element), c = this, d = [b.classPrefix + "mask-hint", b.classPrefix + "mask-animate"];
        ...
        value: function () {
            var a = _p.r(4), b = _p.r(12), c = _p.r(22), d = _p.r(37), e = _p.r(51), f = _p.r(54), g = _p.r(49);
            return _p.r(13).createClass("DropPanel", {
                base: _p.r(60), constructor: function (b) {
                    var c = {button: null, panel: null, width: null, height: null};
                    b = a.extend({}, c, b), this.callBase(b)
                }, disable: function () {
                    this.callBase()
                }, enable: function () {
                    ...
                    this.widgetName = "DropPanel", this.__tpl = c, this.__buttonWidget = null, this.__popupWidget = null, this.__panelWidget = null, this.__contentElement = null, this.__maskWidget = null, this.__popupState = !1, "object" != typeof this.__options.button && (this.__options.input = {icon: this.__options.button})
        ...
        value: function () {
            var a = _p.r(4), b = _p.r(12), c = _p.r(24), d = _p.r(37), e = _p.r(45);
            return _p.r(13).createClass("InputButton", {
                base: _p.r(60), constructor: function (b) {
                    var c = {button: null, input: null, placeholder: null, layout: "right"};
                    b = a.extend({}, c, b), this.callBase(b)
                }, getValue: function () {
                    return this.__inputWidget.getValue()
                }, setValue: function (a) {
                    ...
                    this.callBase(), this.widgetName = "InputButton", this.__tpl = c, this.__inputWidget = null, this.__buttonWidget = null, "object" != typeof this.__options.input && (this.__options.input = {placeholder: this.__options.input}), this.__options.input = a.extend({}, this.__options.input, {placeholder: this.__options.placeholder}), "object" != typeof this.__options.button && (this.__options.button = {icon: this.__options.button})
                }, __render: function () {
                    var c = this;
        ...
        value: function () {
            var a = _p.r(4), b = _p.r(25), c = _p.r(43), d = _p.r(50), e = _p.r(49);
            return _p.r(13).createClass("InputMenu", {
                base: _p.r(60), constructor: function (b) {
                    var c = {input: null, menu: null, mask: null, selected: -1};
                    b = a.extend({}, c, b), this.callBase(b)
                }, select: function (a) {
                    this.__menuWidget.select(a)
                }, selectByValue: function (a) {
                    ...
                    var d = this.__getItemValues()[b], e = -1;
                    ...
                    var b = this.__inputWidget.getValue(), c = b.toLowerCase(), d = this.__getItemValues().labels, e = null;
                    b && (a.each(d, function (a, b) {
                        return 0 === b.toLowerCase().indexOf(c) ? (e = b, !1) : void 0
                    }), e && (this.__inputWidget.setValue(e), this.__inputWidget.selectRange(b.length)))
                }, __getItemValues: function () {
                    ...
                    var b = this.__getItemValues(), c = b.labels, d = -1, e = this.__inputWidget.getValue(), f = this.__lastSelect;
                    a.each(c, function (a, b) {
                        ...
                        from: f || {index: -1, label: null, value: null},
                        to: {index: d, label: e, value: b.values[d]}
                    })
                }, __appendMenu: function () {
                    this.__menuWidget.appendTo(this.__inputWidget.getElement().ownerDocument.body)
                }, __initOptions: function () {
        ...
        value: function () {
            var a = _p.r(12), b = _p.r(4), c = _p.r(26);
            return _p.r(13).createClass("Input", {
                base: _p.r(60), constructor: function (a) {
                    ...
                    if (a || (a = 0), b || (b = 1e9), this.__element.setSelectionRange)this.__element.setSelectionRange(a, b); else {
                    ...
                    this.callBase(), this.on("keydown", function (a) {
                        13 === a.keyCode && this.trigger("inputcomplete", {value: this.getValue()})
                    })
                }
            })
        }
        ...
        value: function () {
            var a = _p.r(13), b = _p.r(27), c = _p.r(42), d = _p.r(48), e = _p.r(12), f = _p.r(4);
            return a.createClass("Item", {
                base: _p.r(60), constructor: function (a) {
                    var b = {label: "", icon: null, selected: !1, textAlign: "left"};
                    ...
                    this.callBase(), this.widgetName = "Item", this.__tpl = b, this.__iconWidget = null, this.__labelWidget = null, this.__selectState = this.__options.selected, "object" != typeof this.__options.label && (this.__options.label = {text: this.__options.label}), this.__options.label.textAlign || (this.__options.label.textAlign = this.__options.textAlign), "object" != typeof this.__options.icon && (this.__options.icon = {img: this.__options.icon})
                }
            })
        }
    }, _p[47] = {
        value: function () {
            var a = _p.r(13), b = _p.r(12), c = _p.r(48), d = _p.r(4);
            return a.createClass("LabelPanel", {
                base: _p.r(51), constructor: function (a) {
                    var b = {layout: "bottom"};
                    ...
                    var a = null, e = this.__options, f = this.__element, g = b.classPrefix, h = "fui-label-panel-content", i = null;
                    ...
                    this.callBase(), this.widgetName = "LabelPanel", this.__labelWidget = null, "object" != typeof a && (this.__options.label = {text: a}), this.__options.label.className || (this.__options.label.className = ""), this.__options.label.className += " fui-label-panel-label"
                }
            })
        }
    }, _p[48] = {
        value: function () {
            var a = _p.r(13), b = _p.r(28), c = _p.r(4);
        ...
        value: function () {
            ...
            var b = _p.r(13), c = _p.r(29), d = _p.r(60), e = _p.r(4), f = !1, g = [];
            return b.createClass("Mask", {
                base: _p.r(60), constructor: function (a) {
                    var b = {bgcolor: "#000", opacity: 0, inner: !0, target: null, scroll: !1, hide: !0};
                    a = e.extend({}, b, a), this.callBase(a)
                }, maskTo: function (a) {
                    ...
                    this.on("mousewheel", function (a) {
                        ...
                        a.preventDefault(), a.stopPropagation(), this.trigger("scroll", {delta: b.wheelDelta || b.deltaY || b.detail})
                    ...
                    var a = null, c = null;
                    this.__targetIsBody() ? a = {top: 0, left: 0} : (c = b.getRect(this.__target), a = {
                        top: c.top,
                        left: c.left
        ...
        value: function () {
            var a = _p.r(13), b = _p.r(46), c = _p.r(12), d = _p.r(4);
            return a.createClass("Menu", {
                base: _p.r(54), constructor: function (a) {
                    var b = {column: !0, selected: -1, textAlign: "left", items: []};
                    a = d.extend({}, b, a), this.callBase(a)
                }, select: function (a) {
                    ...
                    var a = this, e = this.__options.textAlign, f = this.__options.selected;
                    this.callBase(), d(this.__element).addClass(c.classPrefix + "menu"), d.each(this.__options.items, function (c, d) {
                        "object" != typeof d && (d = {label: d}), d.selected = c === f, d.textAlign = e, a.appendItem(new b(d))
                    })
                }, __initEvent: function () {
                    ...
                    if (this.__currentSelect > -1 && this.__widgets[this.__currentSelect].unselect(), this.__prevSelect = this.__currentSelect, this.__currentSelect = this.indexOf(a), a.select(), c = {
                        ...
                        this.trigger("change", {
                            from: {
                                ...
                                label: d && d.getLabel(),
                                value: d && d.getValue()
                            }, to: {index: this.__currentSelect, label: a.getLabel(), value: a.getValue()}
                        })
                    }
                }, __valid: function (a) {
        ...
        value: function () {
            var a = _p.r(13), b = _p.r(30), c = _p.r(4);
            return a.createClass("Panel", {
                base: _p.r(39), constructor: function (a) {
                    var b = {};
                    a = c.extend({}, b, a), this.callBase(a)
                }, __render: function () {
                    var a = null;
        ...
        value: function () {
            var a = _p.r(13), b = _p.r(12), c = _p.r(4), d = _p.r(50);
            return a.createClass("PopupMenu", {
                base: _p.r(53), constructor: function (a) {
                    this.callBase(c.extend({menu: {}}, a))
        ...
        value: function () {
            var a = _p.r(13), b = _p.r(12), c = _p.r(60), d = _p.r(49), e = _p.r(4);
        ...
        value: function () {
            var a = _p.r(13), b = _p.r(12), c = _p.r(60), d = b.layout, e = _p.r(4);
            return a.createClass("PPanel", {
                base: _p.r(51), constructor: function (a) {
                    ...
                    var a = null, c = b.classPrefix + "ppanel-position";
                    ...
                    if (this.__target) {
                        var b = e(this.__element), c = b.outerWidth(), d = b.outerHeight(), f = a.width - c - d;
                        this.__element.style.minWidth = Math.max(f, 0) + "px"
                    }
                }, __resizeHeight: function () {
                    var b = null, c = null, d = 0;
                    ...
                    var c = {top: 0, left: 0}, e = b, f = a.getRect(this.__element);
                    switch (this.__layout) {
                        case d.LEFT_TOP:
                    ...
                    var c = a.getRect(this.__element), e = a.getRect(this.__target), f = this.__getBoundRect();
                    switch (this.__layout) {
                        case d.LEFT_TOP:
                        case d.LEFT_BOTTOM:
        ...
        value: function () {
            var a = _p.r(4), b = _p.r(12), c = _p.r(51), d = _p.r(54), e = _p.r(37), f = _p.r(0), g = _p.r(49);
            return _p.r(13).createClass("SelectMenu", {
                base: c, constructor: function (b) {
                    var c = {
                        bed: {className: "fui-select-menu-bed"},
                        button: {className: "fui-select-menu-btn"},
                        events: ["btnclick"],
                        selected: -1
                    };
                    b = a.extend({}, c, b), this.callBase(b)
                    ...
                    var b = this.__widgets[a], c = "fui-select-menu-selected", d = this.__selected, e = this.__widgets[this.__selected], f = this.__bed.getElement();
        ...
        value: function () {
            var a = _p.r(13), b = _p.r(31), c = _p.r(4);
            return a.createClass("Separator", {
                base: _p.r(60), constructor: function (a) {
                    var b = {width: 1, height: "100%", bgcolor: "#e1e1e1"};
                    a = c.extend({}, b, a), this.callBase(a)
                }, __initOptions: function () {
        ...
        value: function () {
            var a = _p.r(4), b = _p.r(12), c = _p.r(32), d = _p.r(37), e = _p.r(45), f = _p.r(51);
            return _p.r(13).createClass("SpinButton", {
                base: _p.r(60), constructor: function (b) {
                    ...
                    this.callBase(), this.__buttons = [new d({className: b.classPrefix + "spin-up-btn"}), new d({className: b.classPrefix + "spin-down-btn"})], this.__inputWidget = new e, this.__panelWidget = new f({column: !0}), this.__inputWidget.appendTo(this.__element), this.__panelWidget.appendWidget(this.__buttons[0]), this.__panelWidget.appendWidget(this.__buttons[1]), this.__panelWidget.appendTo(this.__element), this.__initSelected(this.__options.selected)
                }, __initEvent: function () {
                    var a = this;
        ...
        value: function () {
            var a = _p.r(4), b = _p.r(12), c = _p.r(33), d = _p.r(37), e = _p.r(51);
            return _p.r(13).createClass("Tabs", {
                base: _p.r(60), constructor: function (b) {
                    var c = {selected: 0, buttons: [], panels: []};
                    b = a.extend({}, c, b), this.callBase(b)
                }, getButtons: function () {
                    return this.__btns
                }, getButton: function (a) {
                    ...
                    return {button: this.getButton(a), panel: this.getPanel(a)}
                }, appendTab: function (a) {
                    return a.panels = a.panels || [], this.__renderByOptions(a)
                }, removeTab: function (a) {
                    if (0 > a)return null;
                    var b = this.__btns.splice(a, 1), c = this.__panels.splice(a, 1);
                    return b.length ? (b = b[0], c = c[0], b.remove(), c.remove(), {button: b, panel: c}) : null
                }, select: function (a) {
                    var b = null;
                    ...
                    var c = this, f = [], g = this.__btns, h = this.__panels, i = this.__btnWrap, j = this.__panelWrap;
                    return a.each(b.buttons, function (a, k) {
                        var l = null, m = null;
                        "object" != typeof k && (k = {label: k}), l = new d(k), l.on("click", function () {
                    ...
                    var c = this.getButton(a), d = this.getButton(this.__selected), e = b.classPrefix + "selected";
                    ...
                    return {index: a, button: this.getButton(a), panel: this.getPanel(a)}
                }
            })
        }
    }, _p[59] = {
        value: function () {
            var a = _p.r(4), b = _p.r(12);
            return _p.r(13).createClass("ToggleButton", {
                base: _p.r(37), constructor: function (b) {
                    var c = {pressed: !1};
                    b = a.extend({}, c, b), this.callBase(b)
                }, isPressed: function () {
                    return this.__state
        ...
        value: function () {
            ...
            var b = "_fui_", c = 0, d = _p.r(12), e = _p.r(11), f = _p.r(4), g = _p.r(13), h = _p.r(13).createClass("Widget", {
                constructor: function (a) {
                    ...
                    if (g.isElement(a))a.appendChild(this.__element); else {
                    ...
                    var a = null, b = this.__tpl, c = this.__options, h = null;
    ...
    var moduleMapping = {"fui.export": 61};
    use("fui.export")
}();
