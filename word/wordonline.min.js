...
!function () {
    !function () {
        ...
        var resouces = {
            ui: {
                ...
                tabs: {idea: "思路", appearence: "展现", view: "视图"},
                menu: {
                    mainmenutext: "EMR脑图",
                    newtab: "新建",
                    opentab: "打开",
        ...
        WO.utils = {
            openGetWin: function (a, b) {
                ...
                return function (b) {
                    if (!a) {
                        var c, d, e;
                        if (a = {}, e = location.hash.substr(1))for (e = e.split("&"), c = 0; c < e.length; c++)d = e[c].split("="), a[d[0]] = d[1]
                    }
                    return a[b]
                }
            }()
        ...
        $.extend(WO, {
            showMsg: function (c) {
                ...
                try {
                    document.title = a ? a + " - EMRDoc" : "EMRDoc"
                } catch (b) {
                }
            }
        })
        ...
        $.extend(WO, {
            initRequester: function () {
                ...
                create: function (a, b) {
                    ...
                    WO.addMask(), WO.showMsg({keepshow: !0, content: "正在打开文档..."}), $.get(i, {
                        cmd: "opendoc",
                        fid: b.fid,
                        path: b.path
                    }, function (b) {
                    ...
                    WO.showMsg({
                        keepshow: !0,
                        content: "正在保存文档..."
                    }), $.post(i + "?cmd=savedoc&fid=" + g + "&path=" + f + "&newpath=" + (b.newpath || f) + "&docid=" + c + (e ? "&path=" + d : ""), {content: b.content}, function (b) {
                        var c = j(b);
                    ...
                    var b = function (d, e) {
                        ...
                        f && "SUCCESS" == f.state && f.path ? (WO.updateMsg({
                            ...
                            timeout: 3e3,
                            content: "文档转换出错!"
                        }), a.off("uploadSuccess", b), a.off("uploadError error", c)
                    }, c = function () {
                        $(document.body).removeClass("loading"), WO.updateMsg({
                            timeout: 3e3,
                            content: "文档转换出错!"
                        }), a.off("uploadSuccess", b), a.off("uploadError error", c)
                    };
                    ...
                    WO.showMsg({keepshow: !0, content: "正在获取上传文档..."}), WO.addMask(), $.get(i, {
                        cmd: "openuploadeddoc",
                        fid: c.fid
                    }, function (c) {
                        WO.removeMask();
    ...
    //    a.setup(fio.user)
        ...
        var a = {
            ...
            "string" != typeof b && (c = b);
            var d, e, f = c.keyCode;
            if (91 != f)for (e in a)d = e.match(/(ctrl\+)?(shift\+)?(alt\+)?([\d]+)/), !(c.ctrlKey || c.metaKey) ^ Boolean(d[1]) && !c.shiftKey ^ Boolean(d[2]) && !c.altKey ^ Boolean(d[3]) && f == d[4] && WO.fire(a[e], a[e], c)
        };
        ...
        function a() {
            ...
            if (!WO._confirmDialog) {
                var c = new FUI.Dialog({
                    ...
                    mask: {className: "wo-confirm-mask", opacity: .2}
                });
                c.on("ok", function () {
                    b && b()
                }), c.on("open", function () {
        ...
        return {
            shortcutkey: {upsize: 'ctrl+187"', downsize: "ctrl+189"}, commands: {
                upsize: {
                    execCommand: function () {
        ...
        function a(a, b) {
            ...
            if (c = k.getOpt(l + "FieldName"), d = k.getOpt(l + "UrlPrefix"), e = k.getOpt(l + "MaxSize"), f = k.getOpt(l + "AllowFiles"), g = k.getActionUrl(k.getOpt(l + "ActionName")), i = function (a) {
                    ...
                    b && UE.dom.domUtils.remove(b), k.fireEvent("showmessage", {
                        id: m,
                        content: a,
                        type: "error",
                        timeout: 4e3
        ...
        return {
            outputRule: function (a) {
                ...
                defaultOptions: {enableDragUpload: !0, enablePasteUpload: !0}, ready: function () {
                    var d = this;
                    if (window.FormData && window.FileReader) {
                        var e = function (e) {
                            var f, g = !1;
                            if (f = "paste" == e.type ? b(e) : c(e)) {
                                for (var h, i = f.length; i--;)h = f[i], h.getAsFile && (h = h.getAsFile()), h && h.size > 0 && (a(h, d), g = !0);
                                g && e.preventDefault()
                            }
                        };
                ...
                UE.dom.domUtils.on(l, "change", function () {
                    ...
                    function b(a) {
                        if (d) {
                            ...
                            b && UE.dom.domUtils.remove(b), c.fireEvent("showmessage", {
                                id: d,
                                content: a,
                                type: "error",
                                timeout: 4e3
        ...
        execCommand: function () {
            ...
            WO.utils.openPostWin(WO.WO_ROOT_URL + "preview.php", {
                ...
                createTime: a(),
                author: 'username'//fio.user.current().username
            })
        }, notNeedUndo: 1
    ...
    //    var a = window.DEBUG ? "./src.php" : "./", b = $('<div class="left">   <a class="guide logo-doc logo" href="' + a + '">EMRDoc</a>   <a class="guide logo-wenku beta" href="http://wenku.baidu.com" target="_blank">EMR文库</a></div>').appendTo("#header"), c = b.find(".logo-wenku");
    ...
    //            }
    //        }).fadeIn("slow").animate({"margin-left": 0}, 100, "linear")
    //    }
    //
    ...
    //    function a(a) {
    //        if (a)j.setLabel(a.username), j.getIconWidget().setImage(a.smallImage), j.show(), i.hide(), fio.user.fire("login", a); else {
    ...
    //
    //    function c() {
    //        //i.setLabel(WO.getLang("ui.loggingin")), fio.user.login({
    ...
    //    }
    //
    //    var f, g = (WO.getUI("eve"), WO.editor, $('<div class="user-panel right"></div>').appendTo("#header")), h = $('<span class="loading-tip"></span>').text(WO.getLang("ui.checklogin")).appendTo(g), i = new FUI.Button({
    //        label: WO.getLang("ui.login"),
    //        text: WO.getLang("ui.login"),
    //        className: "login-button"
    //    }).appendTo(g[0]).hide(), j = new FUI.Button({
    //        icon: {img: "data:image/gif;base64,R0lGODlhAQABAIAAAAUEBAAAACwAAAAAAQABAAACAkQBADs="},
    //        className: "user-button"
    //    }).appendTo(g[0]).hide(), k = new FUI.PopupMenu({className: "user-menu"}).appendTo(document.getElementById("content-wrapper")).positionTo(j), l = k.getMenuWidget().show();
    ...
    //        //})
    //    }), i.on("click", c), $("#content-wrapper").delegate(".login-button", "click", c), {
    //        getCurrent: function () {
    //            return f
    //        }, loginLink: function () {
    //            return $("<a></a>").click(c)
    ...
    //    function a(a, d, e) {
    //        var f = WO.getLang("ui.quickvisit." + a), g = new FUI.Button({
...
/*    }), WO.registerUI("topbar/fastvisit/upload", function () {
        ...
        } else $(b.getElement()).on("click", function () {
            WO.fire("needflash")
        })*/
    }), function () {
        var a = {}, b = window.FUIToolbar = {
        ...
        var a = {
            ...
            text: "字体格式",
            select: 0,
            input: {placeholder: "字体格式"},
            menu: {
                items: function () {
                    var a = [];
                    return $.each([{name: "songti", val: "宋体,SimSun"}, {
                        name: "yahei",
                        ...
                        a.push({
                            value: c.val,
                            label: {text: c.name, style: {"font-family": c.val, "font-size": "18px"}}
                        })
                    }), a
                }()
            }
            ...
            text: "编号",
            selected: 1,
            buttons: [{className: "fui-button-menu-button"}, {className: "fui-button-menu-down"}],
            menu: {
                items: [{label: "○ 空心项目符号", value: "circle"}, {label: "● 实心项目符号", value: "disc"}, {
                    label: "■ 方形项目符号",
                    value: "square"
                }]
            }
            ...
            buttons: [{className: "fui-button-menu-button"}, {className: "fui-button-menu-down"}],
            menu: {
                items: [{label: "1., 2., 3., 4.,  ", value: "decimal"}, {
                    label: "a., b., c., d.,  ",
                    value: "lower-alpha"
            ...
            buttons: [{className: "fui-button-menu-button"}, {className: "fui-button-menu-down"}],
            menu: {
                items: [{label: "5px", value: 5}, {label: "10px", value: 10}, {
                    label: "15px",
                    value: 15
                }, {label: "20px", value: 20}, {label: "25px", value: 25}]
            }
        }, f = {
            clazz: "ButtonMenu",
            id: "rowspacingbottom",
            ...
            button: {className: "fui-drop-panel-down"}
        };
            ...
            widgets: [{
                ...
                widgets: [{
                    ...
                    widgets: [{
                        ...
                        text: "撤销",
                        label: "撤销"
                    }, {clazz: "Button", id: "redo", className: "wo-btn wo-btn-redo", text: "恢复", label: "恢复"}]
                }, {
                    clazz: "Panel",
                    className: "wo-line",
                    widgets: [{
                ...
                widgets: [{
                    ...
                    widgets: [{
                        ...
                        text: "复制",
                        label: "复制"
                    }, {clazz: "Button", id: "cut", className: "wo-btn wo-btn-cut", text: "剪切", label: "剪切"}]
                }, {
                    clazz: "Panel",
                    className: "wo-line",
                    widgets: [{
                ...
                widgets: [{
                    ...
                    widgets: [b, {
                        ...
                        text: "下标"
                    }, {clazz: "Button", id: "bold", className: "wo-btn wo-btn-bold", text: "加粗"}, {
                        clazz: "Button",
                        id: "italic",
                        ...
                        text: "文字颜色"
                    }, {clazz: "Button", id: "backcolor", className: "wo-btn wo-btn-backcolor", text: "背景颜色"}]
                }]
            }, {
                clazz: "LabelPanel",
                id: "blockparagraph",
                ...
                widgets: [{
                    ...
                    widgets: [{
                        ...
                        text: "增加缩进"
                    }, {clazz: "Button", id: "blockoutdent", className: "wo-btn wo-btn-blockoutdent", text: "减少缩进"}]
                }, {clazz: "Panel", className: "wo-line wo-line-2", widgets: [c, d, e, f, g]}]
            }, {
                clazz: "LabelPanel",
                id: "blockstyle",
        ...
        FUIToolbar.MainConfig.buttons.push({
            ...
            widgets: [{
                ...
                widgets: [{
                    ...
                    label: "字符",
                    layout: "bottom",
                    _dialog: {width: 620, height: 575, caption: "插入字符"}
                }]
            }, {
                clazz: "LabelPanel",
                id: "blocklink",
                ...
                widgets: [{
                    ...
                    text: "添加链接",
                    label: "添加链接",
                    _dialog: {width: 420, height: 250, caption: "添加链接"}
                }, {clazz: "Button", id: "unlink", className: "wo-btn wo-btn-unlink", text: "取消链接", label: "取消链接"}]
            }, {
                clazz: "LabelPanel",
                id: "blockimage",
                ...
                widgets: [{
                    ...
                    label: "图片",
                    layout: "bottom",
                    _dialog: {width: 650, height: 470, caption: "插入图片"}
                }, {
                    clazz: "Panel",
                    className: "wo-line",
                    widgets: [{
                        ...
                        widgets: [{
                            ...
                            widgets: [{
                                ...
                                text: "涂鸦",
                                label: "涂鸦",
                                _dialog: {width: 520, height: 430, caption: "插入涂鸦"}
                            }]
                        }]
                    }]
                }]
                ...
                widgets: [{
                    ...
                    label: "地图",
                    layout: "bottom",
                    _dialog: {width: 570, height: 460, caption: "插入地图"}
                }]
            }, {
                clazz: "LabelPanel",
                id: "blockcode",
                ...
                widgets: [{
                    ...
                    id: "inserttable1",
                    _cmd: "inserttable",
                    button: {className: "wo-btn wo-btn-inserttable", text: "表格", label: "表格", layout: "bottom"}
                }]
            }, {
                clazz: "LabelPanel",
                id: "blockformula",
                ...
                widgets: [{
                    ...
                    label: "公式",
                    layout: "bottom",
                    _popup: {width: 600, height: 400, caption: "插入公式"}
                }]
            }, {
                clazz: "LabelPanel",
                id: "blockcomment",
                ...
                widgets: [{
                    ...
                    label: "批注",
                    layout: "bottom",
                    _dialog: {width: 600, height: 400, caption: "添加批注"}
                }]
            }]
        })
    }(), function () {
            ...
            widgets: [{
                ...
                widgets: [{
                    ...
                    widgets: [{
                        ...
                        id: "inserttable2",
                        _cmd: "inserttable",
                        button: {className: "wo-btn wo-btn-inserttable", text: "插入表格", label: "插入表格", layout: "bottom"}
                    }, {
                        clazz: "Button",
                        id: "deletetable",
                    ...
                    widgets: [{
                        ...
                        widgets: [{
                            ...
                            text: "插入行"
                        }, {clazz: "Button", id: "insertcol", className: "wo-btn wo-btn-insertcol", text: "插入列"}]
                    }, {
                        clazz: "Panel",
                        widgets: [{
                            clazz: "Button",
                            ...
                            text: "删除行"
                        }, {clazz: "Button", id: "deletecol", className: "wo-btn wo-btn-deletecol", text: "删除列"}]
                    }]
                }]
            }, {
                clazz: "LabelPanel",
                ...
                widgets: [{
                    ...
                    widgets: [{
                        ...
                        text: "向下合并单元格"
                    }, {clazz: "Button", id: "mergeright", className: "wo-btn wo-btn-mergeright", text: "向右合并单元格"}]
                }, {
                    clazz: "Panel",
                    widgets: [{
                        clazz: "Button",
                        ...
                        text: "单元格拆分成列"
                    }, {clazz: "Button", id: "splittorows", className: "wo-btn wo-btn-splittorows", text: "单元格拆分成行"}]
                }]
            }]
        })
    }(), function () {
        ...
        FUIToolbar.MainConfig.buttons.push({
            ...
            widgets: [{
                ...
                widgets: [{
                    ...
                    label: "查找替换",
                    layout: "bottom",
                    _dialog: {width: 400, height: 290, caption: "查找替换"}
                }]
            }, {
                clazz: "LabelPanel",
                id: "blockwordcount",
                ...
                widgets: [{
                    ...
                    label: "字数统计",
                    layout: "bottom",
                    _dialog: {width: 340, height: 260, caption: "字数统计"}
                }]
            }, {
                clazz: "LabelPanel",
                ...
                widgets: [{
                    ...
                    label: "共享给好友",
                    layout: "bottom",
                    _dialog: {width: 600, height: 400, caption: "共享给好友"}
                }]
            }, {
                clazz: "LabelPanel",
                id: "blockshare",
        ...
        function a(a, b, c) {
            var d = a._cmd;
            if (a._dialog) {
                var e = WO.WO_URL + "dialogs/", f = a._dialog, g = "wo_" + (+new Date).toString(36), h = new FUI.Dialog(f), i = $(h.getBodyElement()), j = $EDITORUI[g] = {
                    _ishidden: !0,
                    editor: c,
        ...
        function b(a, b, c) {
            var d = a._cmd;
            if (a._popup) {
                var e = WO.WO_URL + "dialogs/", f = a._popup, g = "wo_" + (+new Date).toString(36), h = new FUI.Popup(f), i = $(h.getElement()).find(".fui-panel-content"), j = $EDITORUI[g] = {
                    _ishidden: !0,
                    editor: c,
                    className: "wo-dialog-" + d,
                    uiName: "popup",
        ...
        FUIToolbar.registerWidgetHandler("Button", function (f, g, h) {
            ...
            } else f._dialog || f._popup || g.on("click", function () {
                h.execCommand(i)
            });
        ...
        var d = a._cmd, e = WO.WO_URL, f = {
            className: "wo-fontstyle-buttonset",
            selected: 2,
            buttons: [{
                text: "标",
                icon: e + "themes/default/images/icons/style_01.png",
                value: {
                    tagName: "p",
                ...
                text: "无间隔​",
                icon: e + "themes/default/images/icons/style_02.png",
                value: {
                    tagName: "p",
                ...
                text: "标题 1​",
                icon: e + "themes/default/images/icons/style_03.png",
                value: {
                    tagName: "h1",
                ...
                text: "标题 2​",
                icon: e + "themes/default/images/icons/style_04.png",
                value: {
                    tagName: "h2",
                ...
                text: "标题 3​",
                icon: e + "themes/default/images/icons/style_05.png",
                value: {
                    tagName: "h3",
                ...
                text: "标题 4​",
                icon: e + "themes/default/images/icons/style_06.png",
                value: {
                    tagName: "h4",
                ...
                text: "标题 5​",
                icon: e + "themes/default/images/icons/style_07.png",
                value: {
                    tagName: "h5",
                ...
                text: "标题 6​",
                icon: e + "themes/default/images/icons/style_08.png",
                value: {
                    tagName: "h6",
                ...
                text: "标题 7​",
                icon: e + "themes/default/images/icons/style_09.png",
                value: {
                    tagName: "p",
                ...
                text: "标题 8​",
                icon: e + "themes/default/images/icons/style_10.png",
                value: {
                    tagName: "p",
                ...
                text: "标题 9​",
                icon: e + "themes/default/images/icons/style_11.png",
                value: {
                    tagName: "p",
                ...
                text: "标题​",
                icon: e + "themes/default/images/icons/style_12.png",
                value: {
                    tagName: "p",
                    style: "font-size: 21px; font-style: normal; font-family: Cambria, serif; font-weight: bold; text-decoration: none; color: #000000;"
                }
                ...
                text: "副标题​",
                icon: e + "themes/default/images/icons/style_13.png",
                value: {
                    tagName: "p",
                    style: "font-size: 21px; font-style: normal; font-family: Cambria, serif; font-weight: bold; text-decoration: none; color: #000000;"
                }
                ...
                text: "不明显强调​",
                icon: e + "themes/default/images/icons/style_14.png",
                value: {
                    tagName: "p",
                ...
                text: "强调​",
                icon: e + "themes/default/images/icons/style_15.png",
                value: {
                    tagName: "p",
                ...
                text: "明显强调​",
                icon: e + "themes/default/images/icons/style_16.png",
                value: {
                    tagName: "p",
                ...
                text: "增强​",
                icon: e + "themes/default/images/icons/style_17.png",
                value: {
                    tagName: "p",
                    style: "font-size: 14px; font-style: normal; font-family: 'Microsoft YaHei UI', 'Microsoft YaHei', 微软雅黑, SimSun, 宋体, sans-serif; font-weight: bold; text-decoration: none; color: #000000;"
                }
                ...
                text: "引用​",
                icon: e + "themes/default/images/icons/style_18.png",
                value: {
                    tagName: "p",
                    style: "font-size: 14px; font-style: italic; font-family: 'Microsoft YaHei UI', 'Microsoft YaHei', 微软雅黑, SimSun, 宋体, sans-serif; font-weight: normal; text-decoration: none; color: #404040;"
                }
                ...
                text: "明显引用​",
                icon: e + "themes/default/images/icons/style_19.png",
                value: {
                    tagName: "p",
                ...
                text: "不明显参考​",
                icon: e + "themes/default/images/icons/style_20.png",
                value: {
                    tagName: "p",
                ...
                text: "明显参考​",
                icon: e + "themes/default/images/icons/style_21.png",
                value: {
                    tagName: "p",
                ...
                text: "书籍标题​",
                icon: e + "themes/default/images/icons/style_22.png",
                value: {
                    tagName: "p",
                ...
                text: "列出段落​",
                icon: e + "themes/default/images/icons/style_23.png",
                value: {
                    tagName: "p",
                    style: "font-size: 14px; font-style: normal; font-family: 'Microsoft YaHei UI', 'Microsoft YaHei', 微软雅黑, SimSun, 宋体, sans-serif; font-weight: normal; text-decoration: none; color: #000000;"
                }
                ...
                text: "caption​",
                icon: e + "themes/default/images/icons/style_24.png",
                value: {
                    tagName: "p",
                ...
                text: "toc 1​",
                icon: e + "themes/default/images/icons/style_25.png",
                value: {
                    tagName: "p",
                ...
                text: "toc 2​",
                icon: e + "themes/default/images/icons/style_26.png",
                value: {
                    tagName: "p",
                    style: "font-size: 15px; font-style: normal; font-family: 'Microsoft YaHei UI', 'Microsoft YaHei', 微软雅黑, SimSun, 宋体, sans-serif; font-weight: normal; text-decoration: none; color: #000000;"
                }
                ...
                text: "toc 3​",
                icon: e + "themes/default/images/icons/style_27.png",
                value: {
                    tagName: "p",
                    style: "font-size: 15px; font-style: normal; font-family: 'Microsoft YaHei UI', 'Microsoft YaHei', 微软雅黑, SimSun, 宋体, sans-serif; font-weight: normal; text-decoration: none; color: #000000;"
                }
                ...
                text: "TOC Heading​",
                icon: e + "themes/default/images/icons/style_28.png",
                value: {
                    tagName: "p",
        ...
        var d = a._cmd, e = new FUI.ColorPicker({
            clearText: "清除颜色",
            commonText: "通用颜色",
            standardText: "标准颜色",
            resize: "none"
        ...
        WO.ready(function () {
            function toggle(src, obj, c) {
                obj.duration = 200, obj.easing = "ease", obj.complete = c;
                src.transition(obj);
            }
            ...
            f.appendTo(c), $("#fold-toolbar").on("click", function () {
                $(".fui-selected", d).removeClass("fui-selected"), f.css("display", "none"), toggle(e, {height: "30px"}), toggle($(".main"), {top: "76px"}), b = !1
            }), $(".wo-tabs-btn", WO.toolbar.$tabList).on("click", function () {
                toggle(e, {height: "142px"}, function () {
                    f.css("display", "block")
                }), b || ($("#fold-toolbar").css("display", "none"), $("#dock-toolbar").css("display", "block"))
            }), $("#dock-toolbar").on("click", function () {
                toggle($(".main"), {top: "188px"}), b = !0, $("#fold-toolbar").css("display", "block"), $("#dock-toolbar").css("display", "none")
        ...
        function a(a, b, c, d) {
            ...
            e.appendWidget(g), $(f.getContentElement()).before('<div class="wo-filetab-right-title">EMRDoc</div>'), g.on("click", function () {
                d.close()
            });
        ...
        function b(b, c, d) {
            ...
            var f = this, g = new FUI.Popup({
                id: "filetabpopup",
                className: "wo-filetab",
                mask: {className: "wo-filetab-mask"}
            }), h = $(g.getElement());
            return h.find(".fui-panel-content").addClass("wo-filetab-wrap"), g.appendTo(document.body), g.positionTo(f.$toolbar[0], "left-top"), g._bkopen = g.open, g._bkclose = g.close, g.open = function () {
                h.css({width: 0, height: 0}), g._bkopen(), h.css({top: 0}).animate({
                    width: "100%",
                    height: "100%"
                }, 300, "swing"), h.find(".wo-filetab-right").css({
                    "margin-left": "-150px",
                    background: "#fff"
                }).animate({"margin-left": "0"}, 400, "swing"), !g.isOpen() && e()
            }, g.close = function () {
                h.css({width: "100%", height: "100%"}), g._bkclose(), h.animate({
                    width: 0,
                    height: 0
                }, 300, "linear"), h.find(".wo-filetab-right").animate({"margin-left": "-150px"}, 300, "linear")
            }, c.on("click", function () {
                g.open()
            }), WO.on("esc", function () {
                var a = 0;
        ...
        WO.registerWouiHandler = function (a, b) {
            ...
            }), a.$tabList.prepend(a.menuButton.getElement()), b.call(a, {}, a.menuButton, a.editor), WO.ConfigTraveller(WO.MenuConfig, function (b) {
        ...
        WO.MenuConfig = {
            ...
            className: "wo-tabs",
            buttons: [
            //{clazz: "Button", id: "filenew", title: "新建", label: "新建"},
            //{
            //clazz: "Button",
            //id: "fileopen",
            //title: "打开",
            //label: "打开"
            //}, {clazz: "Button", id: "filesave", title: "保存", label: "保存"}, {
            //    clazz: "Button",
            //    id: "fileshare",
            //    title: "分享",
            //    label: "分享"
            //}, {clazz: "Button", id: "fileprint", title: "打印", label: "打印"}, {
            //    clazz: "Button",
            //    id: "filehelp",
            //    title: "帮助",
            //    label: "帮助"｝
            ],
            panels: [{clazz: "Panel", id: "filepanelnew", _name: "filenew"}, {
                clazz: "Panel",
                id: "filepanelopen",
                _name: "fileopen"
            }, {clazz: "Panel", id: "filepanelsave", _name: "filesave"}, {
                clazz: "Panel",
                id: "filepanelshare",
                _name: "fileshare"
            }, {clazz: "Panel", id: "filepanelprint", _name: "fileprint"}, {
                clazz: "Panel",
                id: "filepanelhelp",
                _name: "filehelp"
            }]
        ...
        return d(function (a) {
            ...
            $(this).hasClass("tpl-add") ? WO.fire("confirm", {
                title: "贡献模板",
                textOk: "确定",
                message: '<p>欢迎贡献你的文档作为模板。<br/>发主题为“贡献模板 - EMRdoc”的邮件到 <a href="mailto:ueditor@baidu.com?subject=贡献模板 - EMRdoc邮件" target="blank">ueditor@baidu.com</a><br/>反馈问题请到 <a href="http://tieba.baidu.com/f?kw=%E7%99%BE%E5%BA%A6doc" target="blank">EMRdoc</a> 贴吧。感谢你的支持！'
        ...
        return j.on("fileclick", function (a) {
            ...
            WO.menu.close(), WO.READONLY ? WO.doc.view({path: a}, function (a) {
                ...
                if (a.html)c.setContent(a.html || "", !1, !0); else if (a.bdjson) {
            ...
            WO.fire("confirm", {
                title: "", message: "文档上传成功，现在打开？", textOk: "打开", textCancel: "取消", onOk: function () {
                    var b = UE.browser.ie ? "&nodl" : "";
        ...
        o.on("click", function () {
            ...
            c != WO.doc.current().path && $.each(i, function (c, d) {
                ...
                message: "文件名已存在，你要替换它吗？", textOk: "替换", textCancel: "取消", onOk: function () {
                    d(c)
                }
            }) : d(c)
        });
        ...
        return WO.isUnSave = !1, WO.on("savedoc saveasdoc", function (a, b) {
            if (b && b.preventDefault(), WO.doc.current().path && "savedoc" == a) {
                ...
                var d = c.getContent();
                if (q == d)return void WO.showMsg({content: "文档已保存", timeout: 2e3});
                e(d)
            } else WO.menu.isOpen() || WO.menu.open(), $("#filesave, #savetowangpan").trigger("click"), setTimeout(function () {
                n.focus()
            })
            ...
            } else $("#wordonline-filename").html("* 未命名文档"), g("* 未命名文档"), a = c.getContent();
            q != a && (WO.isUnSave = !0)
        ...
        function j(a) {
            ...
            d && e && (d.bdTitle = f, d.bdDesc = d.bdText = f + "- 我用「EMRDoc」编辑的文档，快看看吧！", d.bdUrl = c, e && e()), b.show(), $("#share-url").focus()[0].select(), q = "share"
        }
        ...
        UE.browser.mac && (f = WO.WO_URL + "dialogs/help/operation-mac.txt"), $.ajax({
            type: "get",
            dataType: "text",
            url: f,
            success: function (a) {
        ...
        h5: {},
        h6: {},
        img: {src: !0, width: !0, height: !0, alt: !0, __trans: {c: "src", w: "width", h: "height"}},
        math: {},
        obj: {datatype: !0, data: !0, "bg-img": !0, alt: !0, width: !0, height: !0, type: !0},
        li: {},
        ol: {start: !0, type: !0},
        p: {datatype: !0},
        span: {},
        table: {},
        td: {rowspan: !0, colspan: !0, nowrap: !0},
        tr: {},
        ul: {start: !0, type: !0},
        sup: {},
        sub: {},
        ...
        function g(a) {
            if ("span" == a.tagName && (style = a.getAttr("style"))) {
                if (/valign\s*:\s*(sup|sub);?/i.test(style))return a.tagName = RegExp.$1, void a.setAttr("style", style.replace(/valign\s*:\s*(sup|sub);?/i, ""));
                if (/font-style\s*:\s*italic;?/i.test(style))return a.tagName = "em", void a.setAttr("style", style.replace(/font-style\s*:\s*italic;?/i, ""));
                if (/font-weight\s*:\s*(\d+);?/i.test(style) && 1 * RegExp.$1 >= 700)return a.tagName = "strong", void a.setAttr("style", style.replace(/font-weight\s*:\s*(\d+);?/i, ""))
            }
        }
        ...
        function a(a) {
            ...
            if (l = new f({
                    ...
                    children: [],
                    tagName: c
                }), d && l.setAttr("class", g.isArray(d) ? d.join(" ") : d), e(l, a), i)if (g.isArray(i))$.each(i, function (a, b) {
                var c = k(b);
                c && l.appendChild(c)
            }); else if (g.isString(i))l.appendChild(new f({type: "text", data: g.unhtml(i || "")})); else {
        ...
        UE.parseDoc = function (b) {
            ...
            if (b) {
                ...
                for (var k = 0; k < b.length; k++)e = a(b[k]), c(e, d(b[k].style), b[k].baseStyle), h.appendChild(e), i.push(e.toHtml());
                j = i.join("")
            } else alert("文档解析出错");
