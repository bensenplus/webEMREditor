    ...
    //    a.setup(fio.user)
        ...
        FUIToolbar.MainConfig.buttons.push({
            ...
            widgets: [{
                clazz: "LabelPanel",
                id: "blocksave",
                className: "wo-block wo-drafts",
                layout: "top",
                label: "保存",
                widgets: [{
                    clazz: "Button",
                    id: "save",
                    className: "wo-btn wo-btn-save",
                    text: "保存",
                    label: "保存",
                    layout: "bottom"
                }]
                ...
                clazz: "LabelPanel",
                id: "blockwordcount",
                className: "wo-block wo-template",
                layout: "top",
                label: "另存为",
                widgets: [{
                    clazz: "Button",
                    id: "template",
                    className: "wo-btn wo-btn-template",
                    text: "模板",
                    label: "模板",
                    layout: "bottom"
                }]
        ...
        FUIToolbar.MainConfig.buttons.push({
            ...
            widgets: [{
                ...
                widgets: [{
                    clazz: "Button",
                    id: "dropdownlist",
                    className: "wo-btn wo-btn-dropdownlist",
                    text: "选择项",
                    label: "选择项",
                    layout: "bottom",
                    _dialog: {width: 320, height: 280, caption: "插入选择项"}
                }, {
                    clazz: "Button",
                    id: "calendar",
                    className: "wo-btn wo-btn-calendar",
                    text: "日期控件",
                    label: "日期控件",
                    layout: "bottom",
                    _dialog: {width: 320, height: 150, caption: "插入日期控件"}
                }, {
                    clazz: "Button",
                    id: "bindfield",
                    className: "wo-btn wo-btn-bindfield",
                    text: "绑定文本",
                    label: "绑定文本",
                    layout: "bottom",
                    _dialog: {width: 320, height: 150, caption: "插入绑定文本"}
                }]
            }, {
                clazz: "LabelPanel",
                id: "blocktable",
        ...
        WO.ready(function () {
            ...
            f.appendTo(c), $("#fold-toolbar").on("click", function () {
                ...
                toggle($(".main"), {top: "148px"}), b = !0, $("#fold-toolbar").css("display", "block"), $("#dock-toolbar").css("display", "none")
